...
class LoginTest {
    ...
    private lateinit var outhServer: AuthService

    @Before
    fun setup(){
        mockWebServer = MockWebServer()

        outhServer = Retrofit.Builder()
    ...
    fun loginTest() = runTest {
        ...
        val response = outhServer.login(LoginRequest("admin","admin"))
    ...
    fun unsuccessfullLogin()= runTest {
        ...
        val response = outhServer.login(LoginRequest("adminn","adminn"))
        mockWebServer.takeRequest()
